...
set output "performance_lists_total.eps"
...
plot \
	'CoarseGrainLockedList.dat' using ($2):($4):($5) with yerrorbars ls 1 title "Coarse-grain", \
	'' using ($2):($4):($5) with lines ls 1 notitle , \
	'FineGrainLockedList.dat' using ($2):($4):($5) with yerrorbars ls 2 title "Fine-grain", \
	'' using ($2):($4):($5) with lines ls 2 notitle, \
	'OptimisticLockedList.dat' using ($2):($4):($5) with yerrorbars ls 3 title "Optimistic", \
	'' using ($2):($4):($5) with lines ls 3 notitle, \
	'LazyList.dat' using ($2):($4):($5) with yerrorbars ls 4 title "Lazy", \
	'' using ($2):($4):($5) with lines ls 4 notitle, \
	'LockFreeList.dat' using ($2):($4):($5) with yerrorbars ls 5 title "Lock-free", \
	'' using ($2):($4):($5) with lines ls 5 notitle
...
!epstopdf performance_lists_total.eps
!rm performance_lists_total.eps
quit
